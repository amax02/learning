                    ...
                    <div class="row">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{$k == 0 ? 'active' : ''}}" id="{{$v['kategori']}}-tab" data-bs-toggle="tab" data-bs-target="#{{$v['kategori']}}-tab-pane" type="button" role="tab" aria-controls="{{$v['kategori']}}-tab-pane" aria-selected="true">{{ucwords($v['kategori'])}}</button>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade {{$i == 0 ? 'show active' : ''}}" id="{{$kdt}}-tab-pane" role="tabpanel" aria-labelledby="{{$kdt}}-tab" tabindex="0">
                                    <div class="row">
                                        @foreach($dt as $k => $v)
                                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                            <x-element.item-materi :kategori="$v['kategori']" :nama="$v['judul']" :gambar="$v['gambar']" :id="$v['id']" />
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
